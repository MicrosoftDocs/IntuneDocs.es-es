---
title: "Adición de aplicaciones de la tienda de Windows Phone 8.1 a Intune | Versión preliminar de Intune Azure | Microsoft Docs"
description: "Versión preliminar de Intune Azure: aprenda sobre cómo agregar aplicaciones de la tienda de Windows Phone 8.1 a Intune."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
# <a name="how-to-add-windows-phone-81-store-apps-to-intune"></a>Adición de aplicaciones de la tienda de Windows Phone 8.1 a Intune
