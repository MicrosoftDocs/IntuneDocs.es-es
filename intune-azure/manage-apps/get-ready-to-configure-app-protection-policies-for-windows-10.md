...
[Create a WIP app protection policy](https://docs.microsoft.comcreate-windows-information-protection-policy-with-intune.md) (Creación de una directiva de protección de aplicaciones de WIP)
