---
title: "Configuración de la infraestructura de certificados de Intune para SCEP | Versión preliminar de Intune Azure | Microsoft Docs"
description: "Versión preliminar de Intune Azure: aprenda a configurar la infraestructura antes de crear e implementar perfiles de certificado SCEP de Intune."
keywords: 
author: robstackmsft
ms.author: robstack
manager: angrobe
...
---
# <a name="configure-certificate-infrastructure-for-scep-in-intune-azure-preview"></a>Configuración de la infraestructura de para SCEP en la versión preliminar de Intune Azure
...
Ya está listo para configurar perfiles de certificado, como se describe en [Configure certificate profiles](how-to-configure-certificates.md) (Configurar perfiles de certificado).
