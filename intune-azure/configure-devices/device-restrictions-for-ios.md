...
# <a name="ios-device-restriction-settings-in-intune-azure-preview"></a>Configuración de restricciones de dispositivos iOS en la versión preliminar de Intune Azure
