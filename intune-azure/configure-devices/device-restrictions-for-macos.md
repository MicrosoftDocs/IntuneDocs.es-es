...
# <a name="macos-device-restriction-settings-in-intune-azure-preview"></a>Configuración de restricciones de dispositivos macOS en la versión preliminar de Intune Azure
