...
# <a name="vpn-settings-for-android-devices-in-intune-azure-preview"></a>Configuración de VPN para dispositivos Android en la versión preliminar de Intune Azure
