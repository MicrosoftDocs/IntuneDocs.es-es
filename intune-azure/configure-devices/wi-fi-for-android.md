...
# <a name="intune-wi-fi-settings-for-android-devices-in-intune-azure-preview"></a>Configuración de Wi-Fi de Intune para dispositivos Android en la versión preliminar de Intune Azure
