...
# <a name="role-based-access-control-rbac-for-microsoft-intune"></a>Control de acceso basado en rol (RBAC) para Microsoft Intune
...
3. En la hoja **Intune**, elija **Control de acceso**.
