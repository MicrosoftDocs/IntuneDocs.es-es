---
title: Creación de grupos para organizar usuarios y dispositivos
...
> [!TIP]
> Para más información sobre el uso de grupos, consulte [Crear grupos para administrar usuarios y dispositivos en Microsoft Intune](/intune-classic/deploy-use/use-groups-to-manage-users-and-devices-with-microsoft-intune).
...
> /intune/licenses-assign [&larr; **Administrar licencias de Intune**](/intune/licenses-assign)       [**Crear directivas y aplicaciones** &rarr;](./start-with-a-paid-subscription-to-microsoft-intune-step-6.md)  
