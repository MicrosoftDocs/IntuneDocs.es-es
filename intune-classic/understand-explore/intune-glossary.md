...
|||
|-|-|
|Híbrido|Configuración en la que puede administrar dispositivos inscritos con Intune [a través de la consola de System Center Configuration Manager](/intune-classic/get-started/integration-with-cloud-services).|
