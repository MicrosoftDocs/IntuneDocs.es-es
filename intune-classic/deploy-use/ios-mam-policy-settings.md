---
title: "Configuración de directiva de MAM de iOS | Microsoft Docs"
...
La configuración de directivas que se describe en este tema puede [realizarse](create-and-deploy-mobile-app-management-policies-with-microsoft-intune.md) para una directiva de protección de aplicaciones en la hoja **Toda la configuración** de Azure Portal.
