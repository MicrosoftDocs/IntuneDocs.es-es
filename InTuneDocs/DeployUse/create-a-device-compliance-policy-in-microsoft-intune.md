...
# Crear una directiva de cumplimiento normativo de dispositivos en Microsoft Intune
...
##  Paso 1: Agregar una nueva directiva
  En la [consola de administración de Microsoft Intune](https://manage.microsoft.com), elija **Directiva** &gt; **Directivas de cumplimiento normativo** &gt; **Agregar**..
...
## Pasos siguientes
[Implementar y supervisar una directiva de cumplimiento normativo](deploy-and-monitor-a-device-compliance-policy-in-microsoft-intune.md)

### Consulte también
[Introduction to device compliance policies (Introducción a las directivas de cumplimiento normativo de dispositivo)](introduction-to-device-compliance-policies-in-microsoft-intune.md)
