...
## Configurar la inscripción de la aplicación Portal de empresa
...
6.  **Informar a los usuarios**<br>Deberá indicar a los usuarios cómo inscribir sus dispositivos y qué esperar cuando se hayan incorporado a la administración:
