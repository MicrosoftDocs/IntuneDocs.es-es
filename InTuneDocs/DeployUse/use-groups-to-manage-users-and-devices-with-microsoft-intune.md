...
1.  En la consola de administración de Intune, elija **Grupos** &gt; **Información general** &gt; **Crear grupo**..

2.  Especifique un nombre y una descripción opcional para el grupo y seleccione un grupo de dispositivos como grupo primario. Elija **Siguiente**..
...
5.  En la página **Resumen**, revise las acciones que se van a realizar. Elija **Finalizar**..
...
2.  Especifique un nombre y una descripción opcional para el grupo y seleccione un grupo de usuarios como grupo primario. Elija **Siguiente**..
...
Puede configurar vistas de grupo filtradas para los administradores de servicios en la consola de administrador de Intune. Para más información, vea [Información necesaria antes de iniciar Microsoft Intune](/intune/get-started/what-to-know-before-you-start-microsoft-intune)..
...
1.  En la consola de administración de Intune, elija **Administración** &gt; **Administración de administradores** &gt; **Administradores de servicios**..

2.  Seleccione el administrador de servicios para el que quiere filtrar los grupos y haga clic en **Administrar grupos**..

3.  En el cuadro de diálogo **Seleccione los grupos que serán visibles para este administrador de servicios**, agregue los grupos a los que el administrador de servicios seleccionado podrá tener acceso y, después, haga clic en **Aceptar**..
