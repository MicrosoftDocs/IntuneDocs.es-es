...
A excepción de la integración de TeamViewer, todas estas características también se admiten para implementaciones híbridas (Configuration Manager con Intune). Para obtener más información sobre las nuevas características híbridas, consulte la página sobre las [novedades de implementaciones híbridas](https://technet.microsoft.com/en-us/library/mt718155.aspx).
...
Para obtener información sobre todas las características nuevas, consulte [Introducing docs.microsoft.com](https://docs.microsoft.com/teamblog/introducing-docs-microsoft-com/) (Introducción a docs.microsoft.com).
...
Para obtener más información, vea [esta entrada de blog](https://blogs.technet.microsoft.com/microsoftintune/2016/04/28/intune-service-health-is-now-available-in-the-office-365-portal/).


### Administración de aplicaciones

- **SDK de MAM: Admite la configuración de longitud de PIN.** Podrá especificar la longitud del PIN para las aplicaciones de MAM como si fuera el PIN de un dispositivo. Esto requerirá que los usuarios finales cumplan con las nuevas restricciones que establezca. Verán una pantalla de PIN ligeramente modificada para tener en cuenta la entrada más larga. Para obtener más información, consulte [MAM policy settings for Android](/intune/deploy-use/android-mam-policy-settings) (Configuración de directivas de MAM para Android) y [MAM policy settings for iOS](/intune/deploy-use/ios-mam-policy-settings) (Configuración de directivas de MAM para iOS).
...
- **Nuevas aplicaciones disponibles para la administración con directivas de MAM.** Las aplicaciones de Microsoft Word, Excel y PowerPoint para Android ahora pueden asociarse con directivas de MAM en los dispositivos que no están inscritos con Intune. Para ver la lista completa de las aplicaciones compatibles, vaya a la galería de aplicaciones móviles de Microsoft Intune de la página [Microsoft Intune application partners](https://www.microsoft.com/en-us/server-cloud/products/microsoft-intune/partners.aspx) (Socios de aplicaciones de Microsoft Intune).

### Administración de dispositivos

- **Sesiones de asistencia remota para equipos con Windows.** La integración de TeamViewer para equipos Windows administrados por el software cliente de Intune le permitirá establecer sesiones de asistencia remota con equipos Windows como apoyo para su departamento de soporte técnico. Los equipos admitidos incluyen Windows 7, Windows 8, Windows 8.1 y Windows 10.
Para obtener más información, consulte [Common Windows PC management tasks with the Microsoft Intune computer client](/intune/deploy-use/common-windows-pc-management-tasks-with-the-microsoft-intune-computer-client#respond-to-a-remote-assistance-request) (Tareas comunes de administración de equipos Windows con el cliente de equipo de Microsoft Intune).

### Actualizaciones de Portal de empresa

#### Aplicación Portal de empresa de Android

- **Notificaciones del sistema para el usuario final**. Los usuarios finales ahora verán notificaciones del sistema de la aplicación Portal de empresa de Android cuando inscriban o quiten sus dispositivos desde el Portal de empresa.

- **Cambios en las cuentas de administradores de inscripción de dispositivos en la aplicación Portal de empresa Android.** Para mejorar el rendimiento y la escalabilidad, Intune ya no mostrará todos los dispositivos de administradores de inscripción de dispositivos (DEM) en el panel Mis dispositivos de la aplicación Portal de empresa de Android. Solo se muestra el dispositivo local que está ejecutando la aplicación y solo si está inscrito a través de la aplicación Portal de empresa. El usuario de DEM puede realizar acciones en el dispositivo local, pero la administración remota de los demás dispositivos inscritos solo puede realizarse desde la consola de administración de Intune.
-
#### Sitio web del Portal de empresa

**Sitio web del Portal de empresa: el banner de identificación de dispositivos proporcionará más información a los usuarios finales.** Los usuarios finales ahora pueden identificar más fácilmente el dispositivo que han seleccionado cuando están usando el sitio web de Portal de empresa. Si está seleccionado el dispositivo incorrecto, podrán seleccionar el dispositivo correcto al pulsar el vínculo **Pulsar aquí** en el banner de la página principal.
...
Las reglas de notificación de Intune definen a quién se enviará una alerta de correo electrónico a través de Intune. Actualmente, puede configurar reglas de notificación para enviar mensajes de correo electrónico a todos los usuarios de dispositivos de un grupo de dispositivos de Intune que haya creado. Aproximadamente a partir del 1 de junio de 2016, ya no se admitirán los grupos creados por el usuario de destino.
    ...
    Hoy en día, para que una regla de notificación esté destinada a un grupo creado desde la consola de administración de Microsoft Intune, debe seguir los pasos siguientes:

    En el área de trabajo **Administración**, haga clic en **Reglas de notificación** > **Crear nueva regla**.

    En el paso dos del Asistente para crear reglas de notificación, se seleccionan los grupos de dispositivos a los que se destinará la regla. Este paso ("Seleccionar grupos de dispositivos") se va a quitar de la consola de Intune.
...
- **Cambios en la compatibilidad de la aplicación Portal de empresa de iOS**. En los próximos meses, habrá una actualización para la aplicación Portal de empresa de Microsoft Intune para iOS que solo admitirán los dispositivos que ejecuten iOS 8.0 o posterior. Los usuarios no podrán inscribir dispositivos nuevos que ejecuten versiones anteriores a iOS 8.0. Los dispositivos inscritos que ejecuten versiones anteriores a iOS 8.0 seguirán administrándose y, durante un tiempo limitado, podrá seguir usando la aplicación Portal de empresa. Pero los dispositivos deben tener iOS 8.0 o posterior para tener acceso a las últimas versiones de la aplicación Portal de empresa. Le recomendamos que notifique a los usuarios que actualicen a iOS 8.0 o posterior para aprovechar las nuevas características de Intune.
...
- [Marzo de 2016](previous-intune-releases.md)
- [Febrero de 2016](previous-intune-releases.md)
- [Enero de 2016](previous-intune-releases.md)
- [Diciembre de 2015](previous-intune-releases.md)
- [Noviembre de 2015](previous-intune-releases.md)
