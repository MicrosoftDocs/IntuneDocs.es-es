# [Conocer y explorar](/intune/understand-explore/introduction-to-microsoft-intune)
# [Introducción](/intune/get-started/what-to-know-before-you-start-microsoft-intune)
<!-- # [Plan and Design](/intune/plan-design/ways-to-do-enterprise-mobility) -->

# [Implementar y usar](overview-of-device-and-app-lifecycles-in-microsoft-intune.md)
## [Información general sobre los ciclos de vida del dispositivo y aplicación](overview-of-device-and-app-lifecycles-in-microsoft-intune.md)
...
## [Inscribir dispositivos](enroll-devices-in-microsoft-intune.md)
...
##### [Inscripción con el asistente de configuración de iOS](ios-setup-assistant-enrollment-in-microsoft-intune.md)
##### [Inscripción directa de iOS](ios-direct-enrollment-in-microsoft-intune.md)
##### [Inscripción directa de iOS DEP](ios-device-enrollment-program-in-microsoft-intune.md)
#### [Inscribir con el administrador de inscripción de dispositivos](enroll-corporate-owned-devices-with-the-device-enrollment-manager-in-microsoft-intune.md)
#### [Etiquetar dispositivos con números IMEI](specify-corporate-owned-devices-with-international-mobile-equipment-identity-imei-numbers.md)
...
### [Administrar PC](manage-windows-pcs-with-microsoft-intune.md)
#### [Instalar cliente del PC](install-the-windows-pc-client-with-microsoft-intune.md)
#### [Tareas comunes de administración del PC](common-windows-pc-management-tasks-with-the-microsoft-intune-computer-client.md)
#### [Resolver conflictos de directivas del PC](resolve-gpo-and-microsoft-intune-policy-conflicts.md)

## [Configurar dispositivos](manage-settings-and-features-on-your-devices-with-microsoft-intune-policies.md)

### [Administrar la configuración y las funciones de los dispositivos con directivas](manage-settings-and-features-on-your-devices-with-microsoft-intune-policies.md)
...
#### [Configuración de Windows 10 desktop y mobile](windows-10-policy-settings-in-microsoft-intune.md)
#### [Configuración del equipo de Windows](windows-team-configuration-policy-settings-in-microsoft-intune.md)
#### [Configuración de actualización de edición de Windows](edition-upgrade-policy-settings-in-microsoft-intune.md)
...
#### [Configuración general (heredado)](mobile-device-security-policy-settings-in-microsoft-intune.md)

### [Habilitar el acceso a los recursos de empresa](enable-access-to-company-resources-with-microsoft-intune.md)
#### [Proteger el acceso a los recursos con perfiles de certificado](secure-resource-access-with-certificate-profiles.md)
...
### [Utilizar grupos para administrar usuarios y dispositivos](use-groups-to-manage-users-and-devices-with-microsoft-intune.md)
...
## [Proteger los dispositivos](protect-your-devices-with-microsoft-intune.md)
### [Restablecimiento del código de acceso y el bloqueo remoto](use-remote-lock-and-passcode-reset-in-microsoft-intune.md)
### [Proteger los dispositivos de Windows con MFA](protect-windows-devices-with-multi-factor-authentication.md)
...
### [Omitir bloqueo de activación en iOS](help-protect-ios-devices-with-activation-lock-bypass-for-microsoft-intune.md)
### [Directivas para proteger los PC Windows](policies-to-protect-windows-pcs-in-microsoft-intune.md)
...
### [Agregar aplicaciones para dispositivos móviles](add-apps-for-mobile-devices-in-microsoft-intune.md)
### [Agregar aplicaciones para PC Windows](add-apps-for-windows-pcs-in-microsoft-intune.md)
## [Implementación de aplicaciones](deploy-apps.md)
### [Implementar aplicaciones en dispositivos y PC](deploy-apps-in-microsoft-intune.md)
...
#### [Administrar aplicaciones de Windows adquiridas por volumen](manage-apps-you-purchased-from-the-windows-store-for-business-with-microsoft-intune.md)
...
### [Directivas de configuración de aplicaciones de iOS](configure-ios-apps-with-mobile-app-configuration-policies-in-microsoft-intune.md)
### [Perfiles de aprovisionamiento de aplicaciones móviles iOS](ios-mobile-app-provisioning-profiles.md)
### [Administrar acceso a Internet](manage-internet-access-using-managed-browser-policies.md)


## [Proteger aplicaciones y datos](protect-apps-and-data-with-microsoft-intune.md)
...
#### [Para Windows y Windows Phone](windows-compliance-policy-settings-in-microsoft-intune.md)
...
### [Restringir el acceso al correo electrónico, O365 y otros servicios](restrict-access-to-email-and-o365-services-with-microsoft-intune.md)


#### [Exchange Online & nuevo Exchange Online Dedicated](restrict-access-to-exchange-online-with-microsoft-intune.md)
#### [Exchange local y Exchange Online Dedicated heredado](restrict-access-to-exchange-onpremises-with-microsoft-intune.md)
...
### [Restringir el acceso a las redes (ISE de Cisco)](restrict-access-to-networks.md)

### [Proteger los datos de la aplicación con MAM](protect-app-data-using-mobile-app-management-policies-with-microsoft-intune.md)
#### [Portal de Azure para las directivas MAM](azure-portal-for-microsoft-intune-mam-policies.md)
#### [Cómo configurar directivas MAM](get-ready-to-configure-mobile-app-management-policies-with-microsoft-intune.md)
...
#### [Validar directivas MAM](validate-mobile-application-management.md)
#### [Supervisar cumplimiento de directiva](monitor-mobile-app-management-policies-with-microsoft-intune.md)
...
#### [Experiencia del usuario final](end-user-experience-for-mam-enabled-apps-with-microsoft-intune.md)
...
### [Preparar la línea de aplicaciones empresariales para MAM](decide-how-to-prepare-apps-for-mobile-application-management-with-microsoft-intune.md)
#### [Ajustar aplicaciones iOS](prepare-ios-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md)
#### [Ajustar aplicaciones Android](prepare-android-apps-for-mobile-application-management-with-the-microsoft-intune-app-wrapping-tool.md)
...
#### [Usar el SDK cuando se escribe una aplicación](use-the-sdk-to-enable-apps-for-mobile-application-management.md)


## [Retirar aplicaciones y datos](use-remote-wipe-to-help-protect-data-using-microsoft-intune.md)
### [Usar borrado completo o selectivo](use-remote-wipe-to-help-protect-data-using-microsoft-intune.md)
...
## [Qué decirles a los usuarios finales](what-to-tell-your-end-users-about-using-microsoft-intune.md)

## [Migrar a Intune](migrate-to-intune.md)

## [Novedades](whats-new-in-microsoft-intune.md)

# [Desarrollar y personalizar aplicaciones](/intune/develop/intune-app-sdk)
