...
Para obtener información sobre lo que pasa cuando instala la aplicación Portal de empresa e inscribe su dispositivo, use el vínculo que coincide con el dispositivo que está usando.

- [Windows 10](#windows-10)
- [Windows 8.1 y Windows RT](#windows-8-1-and-windows-rt)
- [Windows Phone 8.1 y Windows Phone 8](#windows-phone-8-1-and-windows-phone-8)
- [Windows 7 y Vista](#windows-7-and-vista)
...
Para obtener los pasos para la inscripción, consulte [Inscriba el dispositivo Windows en Intune](enroll-your-device-in-intune-windows.md). Para obtener información sobre lo que el administrador de TI puede ver en el dispositivo, consulte [¿Qué puede ver mi administrador de TI cuando inscriba el dispositivo en Intune?](what-can-your-it-administrator-see-when-you-enroll-your-device-in-intune-windows.md)..
...
Para obtener información sobre lo que el administrador de TI puede ver en el dispositivo, consulte [¿Qué puede ver mi administrador de TI cuando inscriba el dispositivo en Intune?](what-can-your-it-administrator-see-when-you-enroll-your-device-in-intune-windows.md)..
