...
|-----------------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|NoEnrollmentPolicy|Ninguna directiva de inscripción|Compruebe que se hayan configurado todos los requisitos previos de inscripción, como el certificado de APNs, y que "iOS como plataforma" esté habilitado. Para obtener instrucciones, consulte [Configurar la administración de dispositivos iOS y Mac](/intune/deploy-use/set-up-ios-and-mac-management-with-microsoft-intune).|
