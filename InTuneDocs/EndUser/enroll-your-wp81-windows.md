...
4.  Pulse **Pulse para inscribir o identificar el dispositivo**..

    ![Pantalla Pulse para inscribir o identificar el dispositivo](./media/WP81-enroll-1-swipe-my-devices.png)

5.  Pulse **Inscribir este dispositivo**..

    ![Pantalla Inscribir este dispositivo](./media/WP81-enroll-2-enroll-this-device.png)

6.  Pulse **Agregar cuenta**..

    ![Pantalla Configuración de área de trabajo](./media/WP81-enroll-3-workplace-add-acct.png)

7.  Escriba información adicional cuando se le solicite y luego pulse en **Iniciar sesión** para completar la inscripción. Ahora debería ver su cuenta de área de trabajo en la página **Configuración** &gt; **Área de trabajo**.
...
4.  Si se le pide que instale la aplicación de empresa o un concentrador, asegúrese de que la casilla correspondiente está activada y pulse **Listo**..
