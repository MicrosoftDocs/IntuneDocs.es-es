...
-   Si el usuario recupera el correo a través del cliente de correo nativo del dispositivo en lugar de hacerlo a través de Outlook, Exchange ActiveSync debe estar activado en el dispositivo.     Esto ocurre automáticamente para dispositivos iOS, Windows Phone y Android/KNOX.
...
## Problemas de Exchange ActiveSync

### El dispositivo Android compatible obtiene un aviso de cuarentena
...
### El dispositivo retirado sigue teniendo acceso.
...
### El dispositivo es compatible y se registra en AAD, pero sigue bloqueado
...
## Dispositivo no compatible no bloqueado
...
## Para abrir una incidencia de soporte técnico
...
### Registros de Exchange Connector

#### Información del registro general
...
#### Localizar registros de sincronización
...
##### Excepciones en el siguiente comando de Get
