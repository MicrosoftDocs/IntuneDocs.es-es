...
ms.topic: hub-page
title: "Documentación de Microsoft Intune | Microsoft Docs"
description: Aprenda a usar Microsoft Intune (FIXME)
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune-azure/introduction/what-is-microsoft-intune">Intune en la versión preliminar de Azure Portal</a></h3>
                                            <p>A medida que Microsoft Intune se mueve a Azure Portal, obtenga información sobre los cambios disponibles en el nuevo portal. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/plan-design/introduction">Planeación y diseño de implementación</a></h3>
                                            <p>Recorra paso a paso el proceso para desarrollar un plan de implementación, crear un diseño, incorporarlo en Intune y realizar un lanzamiento de producción.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/deploy-use/how-to-educate-your-end-users-about-microsoft-intune">Presentación de Microsoft Intune a los usuarios finales</a></h3>
                                            <p>Obtenga información sobre cómo puede hacer que los usuarios finales adopten el acceso seguro que Intune proporciona.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://graph.microsoft.io/en-us/docs/api-reference/beta/resources/intune_graph_overview">Trabajo con Intune en Microsoft Graph</a></h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="https://docs.microsoft.com/en-us/enterprise-mobility-security/solutions/enterprise-mobility-fasttrack-program">¿Más de 150 licencias? Aproveche las ventajas de FastTrack</a></h3>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3><a href="/intune/understand-explore/mam-faq">Preguntas más frecuentes de protección MAM y de aplicaciones</a></h3>
                                            <p>Encuentre respuestas a algunas preguntas frecuentes sobre la administración de aplicaciones móviles (MAM) de Intune y la protección de aplicaciones de Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consulte <a href="/intune/understand-explore/introduction-to-microsoft-intune">toda la documentación de Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Obtenga información sobre cómo Intune proporciona capacidades de administración de dispositivos, aplicaciones y datos para dispositivos móviles y PC Windows.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Administración de dispositivos móviles en Microsoft Intune</h3>
                                            <p>Evalúe cómo funciona la administración de dispositivos móviles en Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consulte <a href="/intune/understand-explore/introduction-to-microsoft-intune">toda la documentación de introducción</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Determinación de desafíos, los objetivos y las metas</h3>
                                            <p>Examine los desafíos, los objetivos y las metas que necesita administrar a medida que implementa.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Identificación de escenarios de casos de uso</h3>
                                            <p>Revise algunos casos de uso de ejemplo a medida que identifica los escenarios de caso de uso de implementación. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Desarrollo de un plan de lanzamiento</h3>
                                            <p>Determine los grupos de la organización de destino para la implementación de Intune y el período de tiempo de lanzamiento para cada grupo.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consulte <a href="/intune/plan-design/introduction">toda la documentación de implementación del plan</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                            ...
                            <div class="cardSize">
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            <h3>Configuración de perfiles de dispositivo</h3>
...
<!--                        <li>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consulte <a href="/intune/deploy-use/overview-of-device-and-app-lifecycles-in-microsoft-intune">toda la documentación de procedimientos</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul id="manage-troubleshoot" class="cardsC">
                                ...
                                <div class="cardPadding">
                                    <div class="card">
                                        ...
                                        <div class="cardText">
                                            ...
                                            <p>Lea sobre los problemas conocidos de la versión preliminar de Intune.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>Consulte <a href="/intune/troubleshoot/general-troubleshooting-tips-for-microsoft-intune">toda la documentación de solución de problemas</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
            ...
            <ul id="sdkstools">
                <li>
                    ...
                    <ul id="sdkstools-all" class="cardsC">                       
                        ...
                        <li class="fullSpan">
                            <div class="container">
                                <h3>¿Busca toda la documentación? Consulte <a href="/intune/understand-explore/introduction-to-microsoft-intune">toda la documentación de Intune</a>.</h3>
                            </div>
                        </li>
                    </ul>
                </li>
