...
|**Número de caracteres complejos requeridos en la contraseña**|Especificar el número de caracteres complejos que requiere la contraseña (entre **0** y **4**).<br /><br />Un carácter complejo es un símbolo, como **?**.|
|**Longitud mínima de la contraseña**|Especificar la longitud mínima de la contraseña (entre **4** y **14** caracteres).|
...
|**Caducidad de contraseña (días)**|Especificar cuántos días deben transcurrir para que el usuario deba cambiar la contraseña (entre **1** y **255** días).|
...
|**Editar**|Edite el nombre, el editor y el identificador de paquete de la aplicación seleccionada.|
