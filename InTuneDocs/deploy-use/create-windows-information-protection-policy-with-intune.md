...
-   Obtenga más información sobre [cómo configurar el proveedor de MAM con Intune](https://docs.microsoft.com/intune/deploy-use/get-ready-to-configure-app-protection-policies-for-windows-10).
