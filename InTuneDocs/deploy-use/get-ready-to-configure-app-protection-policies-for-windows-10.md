...
[Create a WIP app protection policy](https://docs.microsoft.com/intune/deploy-use/create-windows-information-protection-policy-with-intune) (Creación de una directiva de protección de aplicaciones de WIP)
