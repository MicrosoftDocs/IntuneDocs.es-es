...
- Por el administrador de TI:
  - Instalación manual
  - Instalación mediante directiva de grupo
  - Instalación incluida en una imagen de disco

- Por los usuarios finales, que instalan manualmente el cliente de software

El cliente de software de Intune, que el administrador de TI distribuye al usuario o que el usuario final descarga, contiene el software mínimo necesario para inscribir el equipo en la administración de Intune. Después de inscribir un equipo, el cliente de software de Intune descarga el software cliente completo que se necesita para la administración del equipo.
...
En los equipos en los que el cliente de software se va a instalar, vaya a la carpeta donde se encuentran los archivos de instalación del software cliente. A continuación, ejecute **Microsoft_Intune_Setup.exe** para instalar el software cliente.
...
La información exacta que ven los usuarios en el portal web puede variar, dependiendo de la entidad de MDM de la cuenta y la plataforma y la versión del equipo del usuario.
