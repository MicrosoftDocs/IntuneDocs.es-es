---
title: "Configurar la suscripción con Lookout | Microsoft Docs"
...
Los pasos siguientes son necesarios para configurar la protección contra amenazas de dispositivo de Lookout:
...
El inquilino de Lookout Mobility Endpoint Security se asociará a la suscripción a Azure AD para integrar Lookout con Intune. Para habilitar la suscripción del servicio de protección contra amenazas de dispositivo de Lookout, el soporte técnico de Lookout (enterprisesupport@lookout.com) necesita la siguiente información:  
