...
description: Especifique las aplicaciones administradas que pueden usar su VPN en dispositivos iOS administrados con Intune.
keywords: 
author: Erikre
ms.author: erikre
manager: angrobe
...
---
# <a name="set-up-per-app-vpn-in-microsoft-intune-for-ios-devices"></a>Configuración de VPN por aplicación para dispositivos iOS en Microsoft Intune

Puede especificar las aplicaciones administradas que pueden usar su red privada virtual (VPN) en dispositivos iOS administrados con Intune. Si especifica una VPN por aplicación en Intune, los usuarios finales podrán conectarse automáticamente mediante la VPN para acceder a documentos empresariales.
...
1. Abra Azure Portal. Elija **More Services** >  (Más servicios) **Supervisión y administración** > **Intune**.
2. Elija **Grupos** y haga clic en **Nuevo grupo**.
3. Escriba el **nombre** del grupo. 
4. Escriba la **descripción** del grupo. 
5. Para la opción **Tipo de pertenencia**, seleccione **Asignada**.
6. Para la opción **Habilitar las características de Office**, seleccione **No**.
7. En la hoja **Miembros** puede buscar los usuarios de la VPN por nombre o correo electrónico.
...
4. Seleccione **VPN base**. En **VPN base**:
    ...
    7. Deshabilite la opción **Tunelización dividida**.
...
6. Haga clic en **Seleccionar grupos** y seleccione los grupos definidos previamente. Haga clic en **Seleccionar**.
7. En la hoja **Asignaciones**, seleccione **Obligatorio** para la opción **Tipo**.
