...
![El ciclo de vida de la aplicación: agregar, implementar, configurar, proteger y retirar.](./media/app-lifecycle.png "Ciclo de vida de la aplicación de Intune")
