...
- Consulte [¿Qué es el cumplimiento de los dispositivos?](device-compliance.md) para obtener más información sobre las directivas de cumplimiento.
- Para conocer los requisitos previos que deben satisfacerse antes de crear una directiva de cumplimiento, vea [Introducción al cumplimiento de dispositivos](device-compliance-get-started.md).
...
1. Elija la directiva y luego **Asignaciones**. A continuación, puede seleccionar **Grupos de seguridad de Azure Active Directory** y asignarlos a la directiva.
...
- **Requerir la habilitación de la protección frente a amenazas de dispositivo**: utilice esta opción para hacer que la evaluación del riesgo de la solución Lookout MTP sea una condición para el cumplimiento. Elija el nivel de amenaza máximo permitido, que es uno de los siguientes:
  - **Ninguno (protegida)**: este nivel de amenaza es el más seguro. Esto significa que el dispositivo no puede tener ninguna amenaza. Si se detecta cualquier nivel de amenaza en el dispositivo, se evaluará como no conforme.
  ...
  - **Alto**: este nivel de amenaza es el menos seguro. Básicamente, esto permite todos los niveles de amenaza. Quizás sea útil si está usando esta solución solo con fines informativos.

## <a name="system-security-settings"></a>Configuración de seguridad del sistema

### <a name="password"></a>Contraseña

- **Requerir una contraseña para desbloquear dispositivos móviles**: seleccione **Sí** para exigir que los usuarios escriban una contraseña antes de poder tener acceso a sus dispositivos.
...
- **Requerir cifrado en el dispositivo móvil**: seleccione **Sí** para exigir que los dispositivos estén cifrados cuando se conecten a los recursos. Los dispositivos se cifran al elegir la opción **Requerir una contraseña para desbloquear dispositivos móviles**.
