...
- **Aplicaciones**: agregue las aplicaciones que se van a ejecutar en el dispositivo del quiosco. Recuerde que puede agregar varias aplicaciones.
  ...
  - **Agregar aplicaciones**de la tienda: Seleccione una aplicación existente que haya agregado o implementado en Intune como [aplicaciones cliente](../apps/apps-add.md), incluidas las aplicaciones LOB. Si no tiene ninguna aplicación enumerada, Intune admite muchos [tipos de aplicaciones](../apps/apps-add.md) que se [agregan a Intune](../apps/store-apps-windows.md).
