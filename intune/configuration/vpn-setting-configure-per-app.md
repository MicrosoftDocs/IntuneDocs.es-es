...
> [!IMPORTANT]
> La VPN por aplicación no es compatible con los perfiles de VPN de IKEv2 para iOS.
...
5. Haga clic en **Aceptar** > **Crear**.
    ...
    ![Creación de un perfil de certificado de confianza para dispositivos iOS en Microsoft Intune](./media/vpn-setting-configure-per-app/vpn-per-app-create-trusted-cert.png)
...
5. Seleccione **VPN automática** > **Tipo de VPN automática** > **VPN por aplicación**.
    ...
    ![En Intune, establezca VPN automática en VPN por aplicación en dispositivos iOS](./media/vpn-setting-configure-per-app/vpn-per-app-automatic.png)
