...
1. En el panel **Intune** de [Azure Portal](https://portal.azure.com), elija **Aplicaciones móviles**.

2. En el panel **Aplicaciones móviles**, elija **Administrar** > **Aplicaciones**.
...
1. En el panel **Aplicaciones móviles: aplicaciones** seleccione la aplicación de iOS Datalert que ha creado en el paso anterior.
