...
Para ver las alertas de los dispositivos sin asignar, en [Intune en Azure Portal](https://aka.ms/intuneportal), elija **Dispositivos** > **Información general** > **Alertas de inscripción** > **Dispositivos sin asignar**.  
