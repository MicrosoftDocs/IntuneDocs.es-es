...
## <a name="enrollment-status-page-tracking-information"></a>Enrollment Status Page tracking information (Información de seguimiento de la página de estado de la inscripción)
