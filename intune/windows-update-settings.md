...
- **Documentación de referencia de Windows**: [BranchReadinessLevel/Update](https://docs.microsoft.com/windows/client-management/mdm/policy-csp-update#update-branchreadinesslevel)  
...
- **Default**: permitir
- **Documentación de referencia de Windows**: [AllowMUUpdateService/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-allowmuupdateservice)
...
- **Default**: permitir
- **Documentación de referencia de Windows**: [ExcludeWUDriversInQualityUpdate/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-excludewudriversinqualityupdate)
...
- **Documentación de referencia de Windows**: [DeferQualityUpdatesPeriodInDays/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-deferqualityupdatesperiodindays)  
...
- **Valor predeterminado**: 0  
- **Documentación de referencia de Windows**: [PauseFeatureUpdatesPeriodInDays/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-deferfeatureupdatesperiodindays)  
...
- *Versión 1709 o versiones posterior de Windows*: de 0 a 365 días  
...
- **Documentación de referencia de Windows**: [ConfigureFeatureUpdateUninstallPeriod/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-configurefeatureupdateuninstallperiod)  
...
- **Instalación automática a la hora de mantenimiento**: las actualizaciones se descargan automáticamente y, luego, se instalan durante el mantenimiento automático cuando el dispositivo no está en uso o funcionando con batería. Cuando es necesario reiniciar, se pide a los usuarios que reinicien durante siete días y luego se fuerza el reinicio.  
  ...
  - **Inicio de horas activas**: especifique una hora de inicio para suprimir los reinicios debido a las instalaciones de actualizaciones.  
    **Documentación de referencia de Windows**: [ActiveHoursStart/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-activehoursstart)  
    **Default**: 8 a. M.  
  ...
  - **Fin de horas activas**: especifique una hora de finalización para suprimir los reinicios debido a las instalaciones de actualizaciones.  
    **Documentación de referencia de Windows**: [ActiveHoursEnd/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-activehoursend)  
    **Default**: 5 p. M.  
...
- **Instalar y reiniciar automáticamente a la hora programada**: especifique un día y una hora de instalación. Si no se especifica, la instalación se ejecuta a las 3 a.m. todos los días, seguida de una cuenta atrás de 15 minutos para un reinicio. El usuario que ha iniciado sesión puede retrasar la cuenta atrás y reiniciar.  
  ...
  **Documentación de referencia de Windows**: [Update/AllowAutoUpdate](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-allowautoupdate)  
  ...
  - **Día de instalación programada**: especifique en qué día de la semana que desee instalar.  
    **Default**: cualquier día  

  - **Hora de instalación programada**: especificar la hora del día en que desea instalar las actualizaciones.  
    **Default**: 3: 00 A.M.  
...
- **Default**: permitir  
- **Documentación de referencia de Windows**: [SetEDURestart/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-setedurestart)  
...
- **Default**: permitir  
- **Documentación de referencia de Windows**: [SetDisablePauseUXAccess/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-setdisablepauseuxaccess)  
...
- **Documentación de referencia de Windows**: [AutoRestartRequiredNotificationDismissal/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-autorestartrequirednotificationdismissal)
...
- **Documentación de referencia de Windows**: [ScheduleRestartWarning/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-schedulerestartwarning)  
...
- **Valor predeterminado**: *esta opción no está configurada de forma predeterminada, y no se presenta ningún aviso a los usuarios*.  
- **Documentación de referencia de Windows**: [ScheduleImminentRestartWarning/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-scheduleimminentrestartwarning) 
...
- **Versión de Windows**: compatible para Windows 10 versión 1803 y posteriores  
...
- **Hacer la transición de los usuarios al reinicio comprometido después de un reinicio automático (días)**  
  ...
  - **Documentación de referencia de Windows**: [EngagedRestartTransitionSchedule/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-engagedrestarttransitionschedule)  
...
- **Posponer el recordatorio de reinicio establecido (días)**  
  ...
  - **Documentación de referencia de Windows**: [EngagedRestartSnoozeSchedule/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-engagedrestartsnoozeschedule)  
...
- **Establecer fecha límite para reinicios pendientes (días)**  
  - **Valor predeterminado**: de forma predeterminada, esta opción no está configurada, pero admite un valor de **2** a **30**.  
  - **Documentación de referencia de Windows**: [EngagedRestartDeadline/Update](https://docs.microsoft.com/en-us/windows/client-management/mdm/policy-csp-update#update-engagedrestartdeadline)  
