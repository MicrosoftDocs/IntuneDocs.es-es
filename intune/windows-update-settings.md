...
- **Permitir al usuario que reinicie (reinicio establecido)**  
  **Valor predeterminado**: No configurado  
  > [!IMPORTANT]  
  > Ya no se recomienda usar la configuración de reinicio de *embragado* . En su lugar, use la nueva configuración de *fecha límite* que sustituye a la configuración de reinicio de *embragado* . Intune dejará [de *admitir la configuración de* reinicio](whats-new.md#plan-for-change-new-windows-updates-settings-in-intune-) de la opción en una actualización futura.
...
- **Usar configuración de fecha límite**  
  **Valor predeterminado**: No configurado  
  > [!IMPORTANT]  
  > A partir de la actualización de agosto de Intune, se recomienda usar la siguiente configuración de fecha límite que sustituye a la configuración de reinicio de la opción activada. Intune dejará [de *admitir la configuración de* reinicio](whats-new.md#plan-for-change-new-windows-updates-settings-in-intune-) de la actividad en una actualización futura de Intune.  
