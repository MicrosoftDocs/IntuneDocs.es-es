...
Nota: Para que el servicio de Intune implemente correctamente un archivo IPA nuevo en el dispositivo, se debe incrementar la cadena CFBundleVersion en el archivo Info.plist del paquete IPA.
