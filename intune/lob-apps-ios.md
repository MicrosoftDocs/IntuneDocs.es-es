...
Use la información de este artículo para agregar aplicaciones de línea de negocio de iOS a Microsoft Intune.
...
2. En el panel **Archivo del paquete de aplicaciones**, elija el botón Examinar y seleccione un archivo de instalación iOS con la extensión **.ipa**.
