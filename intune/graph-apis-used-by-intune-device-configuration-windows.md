---
title: Graph API para configurar los dispositivos en Microsoft Intune - Azure | Microsoft Docs
titleSuffix: ''
description: Ver una lista de todas las entidades de Graph API con el CSP Windows coincidente y desplazamiento de URI en dispositivos Windows 10 y versiones más recientes usados al configurar los dispositivos en Microsoft Intune. Consulte la API de búsqueda de coincidencias y CSP para equipos compartidos, endpoint protection, protección frente a amenazas avanzada de Windows Defender, protección de identidad, los equipos de Windows 10, pantalla completa y Windows Update para empresas.
keywords: ''
...
Microsoft Intune usa el [entidades de la API Graph](https://docs.microsoft.com/graph/api/resources/intune-graph-overview) (abre otro sitio de Docs) para configurar dispositivos (**Intune** > **configuración del dispositivo**) que ejecutan Windows 10 y versiones posteriores. La API Graph usa proveedores de servicios de configuración (CSP) para leer, establecer, cambiar o eliminar valores de configuración de dispositivos.

Esta lista se aplica a:

- Windows 10 y versiones posteriores

Este artículo enumeran las entidades de Graph y su correspondiente CSP 10 de Windows y los URI de desplazamiento.

Esta información es útil para una variedad de escenarios. Por ejemplo, que se usa en Intune, consulte la configuración que desee incluir en configuraciones personalizadas de OMA-URI y así sucesivamente. 

## <a name="windows-10-csps"></a>CSP de Windows 10

Para obtener más información sobre los proveedores de servicios de configuración de Windows 10, consulte el [referencia del proveedor de servicio de configuración](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (abre otro sitio de Docs).

## <a name="graph-api-properties-to-csp-mapping"></a>Propiedades de Graph API para la asignación de CSP

En la lista siguiente se muestra la mayoría de las entidades de Graph API utilizado por Microsoft Intune para la configuración del dispositivo Windows 10. También muestra el CSP correspondiente de 10 de Windows y el desplazamiento de URI.

Para ver las versiones de Windows 10 se aplican las siguientes API, use Windows 10 [referencia del proveedor de servicio de configuración](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (abre otro sitio de Docs).

#### <a name="editionupgradeconfigurationlicense"></a>EditionUpgradeConfiguration.License 
**CSP**: ./Device/Vendor/MSFT/WindowsLicensing  
**Desplazamiento de URI**: /UpgradeEditionWithLicense

#### <a name="editionupgradeconfigurationlicensetype"></a>EditionUpgradeConfiguration.LicenseType 
**CSP**: ./Device/Vendor/MSFT/WindowsLicensing  
**Desplazamiento de URI**: /LicenseKeyType

#### <a name="editionupgradeconfigurationproductkey"></a>EditionUpgradeConfiguration.ProductKey 
**CSP**: ./Device/Vendor/MSFT/WindowsLicensing  
**Desplazamiento de URI**: /UpgradeEditionWithProductKey

#### <a name="editionupgradeconfigurationwindowssmode"></a>EditionUpgradeConfiguration.WindowsSMode 
**CSP**: ./Device/Vendor/MSFT/WindowsLicensing  
**Desplazamiento de URI**: / SMode/SwitchingPolicy

#### <a name="sharedpcconfigurationaccountmanagerpolicy"></a>SharedPCConfiguration.AccountManagerPolicy 
**CSP**: ./Vendor/MSFT/SharedPC  
**Desplazamiento de URI**: /DeletionPolicy, /DiskLevelCaching, /InactiveThreshold, /DiskLevelDeletion

#### <a name="sharedpcconfigurationaccountmanagerpolicy-windows-holographic-for-business-edition-targeted-devices"></a>SharedPCConfiguration.AccountManagerPolicy (Windows Holographic for Business dispositivos de destino de edición) 
...
**CSP**: ./Vendor/MSFT/SharedPC  
**Desplazamiento de URI**: /AccountModel
...
**CSP**: ./Vendor/MSFT/SharedPC  
**Desplazamiento de URI**: /EnableAccountManager
...
**CSP**: ./Vendor/MSFT/SharedPC  
**Desplazamiento de URI**: /KioskModeAUMID
...
**CSP**: ./Vendor/MSFT/SharedPC  
**Desplazamiento de URI**: /MaintenanceStartTime
...
**Desplazamiento de URI**: / Settings/SaveFilesToHost
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**Desplazamiento de URI**: / Settings/AllowPersistence
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**Desplazamiento de URI**: / Settings/PrintingSettings
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**Desplazamiento de URI**: / Settings/AllowVirtualGPU
...
**CSP**: ./Device/Vendor/MSFT/WindowsDefenderApplicationGuard  
**Desplazamiento de URI**: / Settings/ClipboardSettings
...
**CSP**: ./Device/Vendor/MSFT/BitLocker  
**Desplazamiento de URI**: /AllowWarningForOtherDiskEncryption
...
**CSP**: ./Device/Vendor/MSFT/BitLocker  
**Desplazamiento de URI**: /EncryptionMethodByDriveType, /FixedDrivesRequireEncryption, /FixedDrivesRecoveryOptions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/MSSecurityGuide/ConfigureSMBV1ClientDriver
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Connectivity/HardenedUNCPaths
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Connectivity/DiablePrintingOverHTTP
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/CredentialsUI/EnumerateAdministrators
...
**CSP**: ./Device/Vendor/MSFT/Policy **desplazamiento URI**: /Config/Defender/ControlledFolderAccessProtectedFolders
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AttackSurfaceReductionRules
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AttackSurfaceReductionOnlyExclusions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AllowEmailScanning
...
**CSP**: ./Device/Vendor/MSFT/Policy **desplazamiento URI**: /Config/ExploitGuard/ExploitProtectionSettings
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/ExploitGuard/ExploitProtectionSettings
...
**CSP**: ./Device/Vendor/MSFT/Policy **desplazamiento URI**: /Config/Defender/ControlledFolderAccessAllowedApplications
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/EnableControlledFolderAccess
...
**CSP**: ./Device/Vendor/MSFT/Policy **desplazamiento URI**: /Config/Defender/EnableNetworkProtection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/MSSecurityGuide/TurnOnWindowsDefenderProtectionAgainstPotentiallyUnwantedApplications
...
**CSP**: ./Device/Vendor/MSFT/Policy **desplazamiento URI**: /Config/WindowsDefenderSecurityCenter/DisallowExploitProtectionOverride
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/DisableAppBrowserUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/DisableFamilyUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/DisableHealthUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/DisableNetworkUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/HideSecureBoot
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/HideTPMTroubleshooting
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/DisableVirusUI
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/Email
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/Phone
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/URL
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: / WindowsDefenderSecurityCenter/EnableCustomizedToasts, / WindowsDefenderSecurityCenter/EnableInAppCustomization
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsDefenderSecurityCenter/CompanyName
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceGuard/RequirePlatformSecurityFeatures
...
**CSP**: ./Device/Vendor/MSFT/Policy **desplazamiento URI**: /Config/DeviceGuard/EnableVirtualizationBasedSecurity
...
**Desplazamiento de URI**: /Config/DmaGuard/DeviceEnumerationPolicy
...
**Desplazamiento de URI**: /MdmStore/Global/DisableStatefulFtp
...
**CSP**: ./Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/Global/OpportunisticallyMatchAuthSetPerKM
...
**CSP**: ./Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/Global/EnablePacketQueue
...
**CSP**: ./Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/Global/PresharedKeyEncoding
...
**CSP**: ./Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /EnableFirewall, /DisableStealthMode, / blindada, /DisableUnicastResponsesToMulticastBroadcast, /DisableInboundNotifications, /AuthAppsAllowUserPrefMerge, /GlobalPortsAllowUserPrefMerge, /AllowLocalPolicyMerge , /DefaultOutboundAction, /DefaultInboundAction, /DisableStealthModeIpsecSecuredPacketExemption, /AllowLocalIpsecPolicyMerge
...
**Desplazamiento de URI**: /MdmStore/DomainProfile/DefaultInboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/DomainProfile/DisableInboundNotifications

#### <a name="windows10endpointprotectionconfigurationfirewallprofiledomaininboundnotificationsblocked"></a>windows10endpointprotectionconfiguration.firewallProfileDomain.inboundNotificationsBlocked 
**CSP**: ./Device/Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/DomainProfile/EnableFirewall
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/DomainProfile/DefaultOutboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/PrivateProfile/EnableFirewall
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/PrivateProfile/DefaultInboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/PrivateProfile/DisableInboundNotifications
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/PublicProfile/EnableFirewall
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/PublicProfile/DefaultInboundAction
...
**CSP**: ./Device/Vendor/MSFT/Firewall  
**Desplazamiento de URI**: /MdmStore/PublicProfile/DisableInboundNotifications
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_LANManagerAuthenticationLevel
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LanmanWorkstation/EnableInsecureGuestLogons
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/Accounts\_RenameAdministratorAccount
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/Devices\_AllowUndockWithoutHavingToLogon
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/Accounts\_BlockMicrosoftAccounts
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_DigitallySignCommunicationsAlways
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkClient\_SendUnencryptedPasswordToThirdPartySMBServers
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/Accounts\_EnableAdministratorAccountStatus
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/Accounts\_EnableGuestAccountStatus
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsAlways
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/MicrosoftNetworkServer\_DigitallySignCommunicationsIfClientAgrees
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/NetworkSecurity\_DoNotStoreLANManagerHashValueOnNextPasswordChange
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/Accounts\_RenameGuestAccount
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_DisplayUserInformationWhenTheSessionIsLocked
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/LocalPoliciesSecurityOptions/InteractiveLogon\_MachineInactivityLimit
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/MSSLegacy/AllowICMPRedirectsToOverrideOSPFGeneratedRoutes
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/CredentialProviders/AllowPINLogon
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsPowerShell/TurnOnPowerShellScriptBlockLogging
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/RemoteManagement/AllowBasicAuthentication\_cliente
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/RemoteManagement/DisallowDigestAuthentication
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/RemoteManagement/AllowUnencryptedTraffic\_cliente
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/RemoteManagement/AllowBasicAuthentication\_servicio
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/RemoteManagement/DisallowStoringOfRunAsCredentials
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/RemoteManagement/AllowUnencryptedTraffic\_servicio
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/RemoteProcedureCall/RestrictUnauthenticatedRPCClients
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/MSSecurityGuide/ConfigureSMBV1Server
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/MSSecurityGuide/WDigestAuthentication
...
**CSP**: ./Device/Vendor/MSFT/Policy **desplazamiento URI**: /Config/DeviceGuard/RequirePlatformSecurityFeatures
...
**CSP**: ./Device/Vendor/MSFT/Policy **desplazamiento URI**: /Config/SmartScreen/EnableSmartScreenInShell
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/AccessCredentialManagerAsTrustedCaller
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/AccessFromNetwork
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/BackupFilesAndDirectories
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/DenyAccessFromNetwork
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/ChangeSystemTime
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/CreateGlobalObjects
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/CreatePageFile
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/CreatePermanentSharedObjects
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/CreateSymbolicLinks
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/CreateToken
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/DebugPrograms
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/EnableDelegation
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/GenerateSecurityAudits
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/ImpersonateClient
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/IncreaseSchedulingPriority
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/LockMemory
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/ManageAuditingAndSecurityLog
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/ManageVolume
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/ModifyFirmwareEnvironment
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/ProfileSingleProcess
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/RemoteShutdown
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/RestoreFilesAndDirectories
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/UserRights/TakeOwnership
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/TaskScheduler/EnableXboxGameSaveTask
...
**CSP**: Llamada a Graph API de N/D solo **desplazamiento URI**: Solo la llamada N/D Graph API
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Security/AntiTheftMode
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/ApplicationManagement/MSIAlwaysInstallWithElevatedPrivileges
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/ApplicationManagement/AllowAllTrustedApps
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/ApplicationManagement/DisableStoreOriginatedApps
...
**Desplazamiento de URI**: /Configuration
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Authentication/AllowSecondaryAuthenticationDevice
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Authentication/PreferredAadTenantDomainName

#### <a name="windows10generalconfigurationauthenticationwebsignin"></a>Windows10GeneralConfiguration.AuthenticationWebSignIn 
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Authentication/EnableWebSignIn
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Autoplay/SetDefaultAutoRunBehavior
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Bluetooth/AllowPromptedProximalConnections

#### <a name="windows10generalconfigurationbluetoothdevicename"></a>Windows10GeneralConfiguration.BluetoothDeviceName 
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Bluetooth/LocalDeviceName
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Connectivity/AllowVPNOverCellular
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowCopyPaste
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Cryptography/AllowFipsAlgorithmPolicy
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AllowUserUIAccess
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/CloudBlockLevel
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/CloudExtendedTimeout
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/DaysToRetainCleanedMalware
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/ThreatSeverityDefaultAction
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/ExcludedExtensions
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/ExcludedPaths
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AllowRealtimeMonitoring
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/PUAProtection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/ExcludedProcesses
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/SubmitSamplesConsent
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AllowBehaviorMonitoring
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AllowCloudProtection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AllowIntrusionPreventionSystem
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AvgCPULoadFactor
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/AllowScriptScanning

#### <a name="windows10generalconfigurationdefenderscantype"></a>Windows10GeneralConfiguration.DefenderScanType 
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/ScanParameter
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Defender/SignatureUpdateInterval
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/ApplicationManagement/AllowDeveloperUnlock
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowManualMDMUnenrollment
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Display/TurnOffGdiDPIScalingForApps
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/HomePages
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/AllowAutofill
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/AllowInPrivate
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/AllowSideloadingOfExtensions

#### <a name="windows10generalconfigurationedgeblocktabpreloading"></a>Windows10GeneralConfiguration.EdgeBlockTabPreloading 
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/AllowTabPreloading
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/AllowWebContentOnNewTabPage
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/ClearBrowsingDataOnExit

#### <a name="windows10generalconfigurationedgecookiepolicy"></a>Windows10GeneralConfiguration.EdgeCookiePolicy 
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/AllowCookies
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/EnterpriseSiteListServiceUrl
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/SetHomeButtonURL
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/ConfigureHomeButton
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/SetNewTabPageURL

#### <a name="windows10generalconfigurationedgeopenswith"></a>Windows10GeneralConfiguration.EdgeOpensWith 
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/ConfigureOpenMicrosoftEdgeWith
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/PreventCertErrorOverrides

#### <a name="windows10generalconfigurationedgerequiresmartscreen"></a>Windows10GeneralConfiguration.EdgeRequireSmartScreen 
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/AllowSmartScreen
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/ConfigureTelemetryForMicrosoft365Analytics
...
**CSP**: ./User/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/EnterpriseCloudPrint/DiscoveryMaxPrinterLimit
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowWindowsConsumerFeatures
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowDeviceDiscovery
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowSIMErrorDialogPromptWhenNoSIM
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowTaskSwitcher
...
**CSP**: ./User/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowWindowsSpotlight
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/DoNotSyncBrowserSettings

#### <a name="windows10generalconfigurationgamedvrblocked"></a>Windows10GeneralConfiguration.GameDvrBlocked 
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/ApplicationManagement/AllowGameDVR
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceInstallation/PreventInstallationOfMatchingDeviceIDs
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsInkWorkspace/AllowWindowsInkWorkspace
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WindowsInkWorkspace/AllowSuggestedAppsInWindowsInkWorkspace
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/InternetExplorer/IncludeAllNetworkPaths
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/InternetExplorer/DisableSecuritySettingsCheck
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceLock/AllowScreenTimeoutWhileLockedUser/Config
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/AboveLock/AllowActionCenterNotifications
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceLock/PreventLockScreenSlideShow
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceLock/ScreenTimeoutWhileLocked
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Messaging/AllowMMS
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowSyncMySettings
...
**Desplazamiento de URI**: /AllowMicrosoftAccountSignInAssistant
...
**Desplazamiento de URI**: /ProxySettingsPerUser
...
**CSP**: ./Device/Vendor/MSFT/NetworkProxy  
**Desplazamiento de URI**: /AutoDetect
...
**Desplazamiento de URI**: /ProxyAddress, /Exceptions y /UseProxyForLocalAddresses

#### <a name="windows10generalconfigurationnfcblocked"></a>Windows10GeneralConfiguration.NfcBlocked 
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Connectivity/AllowNFC
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceLock/DevicePasswordExpiration

#### <a name="windows10generalconfigurationpasswordminimumageindays"></a>Windows10GeneralConfiguration.PasswordMinimumAgeInDays 
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceLock/MinimumPasswordAge
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceLock/MinDevicePasswordLength
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceLock/DevicePasswordHistory

#### <a name="windows10generalconfigurationpasswordrequired"></a>Windows10GeneralConfiguration.PasswordRequired 
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeviceLock/DevicePasswordEnabled
...
**CSP**: ./Device/Vendor/MSFT/Personalization  
**Desplazamiento de URI**: /LockScreenImageUrl
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Power/RequirePasswordWhenComputerWakesOnBattery
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Power/RequirePasswordWhenComputerWakesPluggedIn
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Power/AllowStandbyStatesWhenSleepingOnBattery
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Power/AllowStandbyWhenSleepingPluggedIn
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Privacy/EnableActivityFeed
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Search/AlwaysUseAutoLangDetection
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Search/DisableBackoff
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Search/DisableRemovableDriveIndexing
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Security/PreventAutomaticDeviceEncryptionForAzureADJoinedDevices

#### <a name="windows10generalconfigurationsettingsblockaccountspage"></a>Windows10GeneralConfiguration.SettingsBlockAccountsPage 
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Settings/PageVisibilityList
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Settings/AllowLanguage
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Security/AllowRemoveProvisioningPackage
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/ApplicationManagement/AllowSharedUserAppData
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Start/NoPinningToTaskbar
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Start/HideAppList
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Start/HideChangeAccountSettings
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Start/HideRecentJumplists
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Start/HideRecentlyAddedApps
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Start/HideRestart
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Start/HideSleep
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Start/HideSwitchAccount
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Start/AllowPinnedFolderHomeGroup
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Security/RequireDeviceEncryption
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/TaskManager/AllowEndTask
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WiFi/AllowAutoConnectToWiFiSenseHotspots

#### <a name="windows10generalconfigurationwifiblocked"></a>Windows10GeneralConfiguration.WiFiBlocked 
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Wifi/AllowWiFi
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WiFi/AllowManualWiFi/Configuration

#### <a name="windows10generalconfigurationwifiscaninterval"></a>Windows10GeneralConfiguration.WiFiScanInterval 
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WiFi/WLANScanMode
...
**CSP**: ./User/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowWindowsSpotlightOnActionCenter
...
**CSP**: ./User/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowTailoredExperiencesWithDiagnosticData
...
**CSP**: ./User/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowThirdPartySuggestionsInWindowsSpotlight
...
**CSP**: ./User/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowWindowsSpotlightWindowsWelcomeExperience
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/AllowWindowsTips
...
**CSP**: ./User/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Experience/ConfigureWindowsSpotlightOnLockScreen
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/ApplicationManagement/AllowStore
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/ApplicationManagement/RequirePrivateStoreOnly
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WirelessDisplay/AllowProjectionToPC
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WirelessDisplay/AllowUserInputFromWirelessDisplayReceiver
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/WirelessDisplay/RequirePINForPairing
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/NetworkIsolation/EnterpriseCloudResources, /Config/NetworkIsolation/EnterpriseIPRange, /Config/NetworkIsolation/EnterpriseIPRangesAreAuthoritative, / config/NetworkIsolation / EnterpriseInternalProxyServers /Config/NetworkIsolation/EnterpriseNetworkDomainNames, /Config/NetworkIsolation/EnterpriseProxyServers, /Config/NetworkIsolation/EnterpriseProxyServersAreAuthoritative, / config/NetworkIsolation / NeutralResources
...
**Desplazamiento de URI**: /RequirePrinting
...
**CSP**: ./Vendor/MSFT/SecureAssessment  
**Desplazamiento de URI**: /AllowScreenMonitoring
...
**CSP**: ./Vendor/MSFT/SecureAssessment  
**Desplazamiento de URI**: /AllowTextSuggestions
...
**CSP**: ./Vendor/MSFT/SecureAssessment  
**Desplazamiento de URI**: /TesterAccount
...
**CSP**: ./Vendor/MSFT/SecureAssessment  
**Desplazamiento de URI**: /LaunchURI
...
**Desplazamiento de URI**: / MOMAgent/WorkspaceID y la WorkspaceKey/MOMAgent /
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / MOMAgent/WorkspaceID
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / MOMAgent/WorkspaceKey
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: /InBoxApps/Connect/AutoLaunch
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / DeviceAccount/correo electrónico
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / DeviceAccount/ExchangeServer
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / DeviceAccount/SipAddress
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: /MaintenanceHoursSimple/Hours/Duration y /MaintenanceHoursSimple/Hours/StartTime
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: /MaintenanceHoursSimple/Hours/Duration
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / propiedades/DoNotShowMyMeetingsAndFiles
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / propiedades/AllowSessionResume
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / propiedades/ScreenTimeout
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / propiedades/SessionTimeout
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: / propiedades/SleepTimeout
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: /InBoxApps/Welcome/CurrentBackgroundPath
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: /InBoxApps/Welcome/AutoWakeScreen
...
**CSP**: ./Vendor/MSFT/SurfaceHub  
**Desplazamiento de URI**: /InBoxApps/Welcome/MeetingInfoOption
...
**Desplazamiento de URI**: /Offboarding 
...
**CSP**: ./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**Desplazamiento de URI**: /Onboarding 
...
**CSP**: ./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**Desplazamiento de URI**: / Configuration/SampleSharing
...
**CSP**: ./Device/Vendor/MSFT/WindowsAdvancedThreatProtection  
**Desplazamiento de URI**: / Configuration/TelemetryReportingFrequency
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/DeliveryOptimization/DODownloadMode
...
**Desplazamiento de URI**: / biometría/FacialFeaturesUseEnhancedAntiSpoofing
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**Desplazamiento de URI**: / {AADTenantId} / directivas/PINComplexity/MaximumPINLength

#### <a name="windowsidentityprotectionconfigurationpinminimumlength"></a>WindowsIdentityProtectionConfiguration.PinMinimumLength 
**CSP**: ./Vendor/MSFT/PassportForWork  
**Desplazamiento de URI**: / {AADTenantId} / directivas/PINComplexity/MinimumPINLength
...
**CSP**: ./Vendor/MSFT/PassportForWork  
**Desplazamiento de URI**: / {AADTenantId} / directivas/PINComplexity/historial
...
**CSP**: ./Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Browser/ConfigureKioskMode
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/KioskBrowser/EnableEndSessionButton

#### <a name="windowskioskconfigurationkioskbrowserenablehomebutton"></a>WindowsKioskConfiguration.KioskBrowserEnableHomeButton 
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/KioskBrowser/EnableHomeButton
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/KioskBrowser/EnableNavigationButtons
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Update/EngagedRestartSnoozeSchedule
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Update/EngagedRestartTransitionSchedule
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Update/PauseFeatureUpdates
...
**CSP**: N/D: Graph API **desplazamiento URI**: N/D: Graph API
...
**CSP**: ./Device/Vendor/MSFT/Policy **desplazamiento URI**: /Config/Update/ActiveHoursStart, /Config/Update/ActiveHoursEnd, /Config/Update/ScheduledInstallDay, /Config/Update/ScheduledInstallTime
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Update/AllowMUUpdateService
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Update/SetEDURestart

#### <a name="windowsupdateforbusinessconfigurationupdateweeks"></a>WindowsUpdateForBusinessConfiguration.UpdateWeeks 
**CSP**: ./Device/Vendor/MSFT/Policy  
**Desplazamiento de URI**: /Config/Update/ScheduledInstallEveryWeek, /Config/Update/ScheduledInstallFirstWeek, /Config/Update/ScheduledInstallFourthWeek, /Config/Update/ScheduledInstallSecondWeek, / config/actualización / ScheduledInstallThirdWeek
...
- [Información general sobre la configuración de dispositivos](device-profiles.md)
- [Referencia del proveedor de servicio de configuración](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (abre otro sitio de Docs)
