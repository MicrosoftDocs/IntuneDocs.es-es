...
Para buscar el informe, inicie sesión en el [Centro de administración del Administrador de puntos de conexión de Microsoft](https://go.microsoft.com/fwlink/?linkid=2109431). Seleccione **Dispositivos** > **Supervisar** y, en *Configuración*, seleccione **Informe de cifrado**.
