...
El primer paso es firmar el código del paquete appx; consulte [Firmar un paquete de aplicaciones con SignTool](https://docs.microsoft.com/windows/uwp/packaging/sign-app-package-using-signtool).

## <a name="upload-your-app"></a>Carga de la aplicación

A continuación, cargaría el archivo appx firmado tal y como se describe en [Carga de una aplicación de línea de negocio de Windows](lob-apps-windows.md).
