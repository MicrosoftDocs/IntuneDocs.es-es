...
La inscripción de DEP no funciona con el [administrador de inscripción de dispositivos](device-enrollment-manager-enroll.md). Además, macOS no admite actualmente el uso de DEP.
...
1. En [Intune en Azure Portal](https://aka.ms/intuneportal), elija **Inscripción de dispositivos** > **Inscripción de Apple**.
...
>[!NOTE]
>A partir de iOS 11, si quiere habilitar la restauración de copia de seguridad de iCloud, debe mostrar "Restaurar" e "Id. de Apple" en las opciones del Asistente para la instalación.

6. Para guardar la configuración del perfil, seleccione **Crear** en la hoja **Crear perfil de inscripción**. El perfil de inscripción aparece en la lista de Perfiles de inscripción del Programa de inscripción de Apple.
