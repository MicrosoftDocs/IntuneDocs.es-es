...
Para obtener ayuda para la instalación de Intune en el dispositivo, consulte [uso de dispositivos administrados para realizar el trabajo]https://docs.microsoft.com/intune-user-help/company-portal-frequently-asked-questions) y [Uso de ancho de banda de red de Intune](network-bandwidth-use.md).
