...
- **Android for Work**: apruebe y sincronice las aplicaciones que ha aprobado para su empresa. Para obtener más información, vea:
    - [Aplicaciones de Android for Work](apps-add-android-for-work.md).
