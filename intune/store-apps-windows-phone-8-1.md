...
7. En el panel **Información de la aplicación**, configure la siguiente información. Cuando haya terminado, haga clic en **Aceptar**. En función de la aplicación que haya elegido, algunos de los valores de este panel pueden haberse rellenado automáticamente:
...
8. Cuando haya terminado, en el panel **Agregar aplicación**, elija **Aceptar**.
