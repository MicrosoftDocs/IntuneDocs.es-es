...
### <a name="export-all-devices-into-csv-files-in-ie-microsoft-edge-or-chrome----2258071---"></a>Exportar todos los dispositivos a archivos CSV en IE, Microsoft Edge o Chrome <!-- 2258071 -->
...
[Dos nuevas opciones](device-restrictions-windows-10.md#microsoft-edge-browser) están ahora disponibles para los dispositivos con el explorador Microsoft Edge: **Path to favorites file** (Ruta de acceso al archivo de favoritos) y **Changes to Favorites** (Cambios en Favoritos).
...
### <a name="prevent-users-of-android-devices-from-changing-their-device-date-and-time----1333292---"></a>Impedir que los usuarios de dispositivos Android puedan cambiar la fecha y la hora de sus dispositivos  <!-- 1333292 -->
...
<!--1459533 -->     En esta versión, hemos realizado las mejoras siguientes en el funcionamiento de la configuración de BitLocker en un perfil de dispositivo de Endpoint Protection de Windows 10:
 
