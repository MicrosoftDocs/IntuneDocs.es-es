...
Ayude a resolver problemas de actualizaciones de software en Microsoft Intune.
...
**Solución**:  
1. Inicie sesión en el [Azure Portal](https://portal.azure.com) y abra **Microsoft Intune**. 
