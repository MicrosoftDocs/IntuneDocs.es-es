...
3. Habilite la inscripción predeterminada indicando el siguiente valor en el manifiesto:
   ```xml
...
4. Habilite la directiva de MAM necesaria indicando el siguiente valor en el manifiesto:
   ```xml
