---
title: Instancias de Graph API para configurar dispositivos en Microsoft Intune (Azure) | Microsoft Docs
titleSuffix: ''
description: Vea una lista de todas las entidades Graph API con el CSP de Windows y el URI de desplazamiento coincidentes en dispositivos con Windows 10 y versiones posteriores que se usan a la hora de configurar dispositivos en Microsoft Intune. Vea la API y el CSP coincidentes para equipos compartidos, Endpoint Protection, la protección contra amenazas avanzada de Microsoft Defender, la protección de identidad, Teams para Windows 10, Quiosco y Windows Update para empresas.
keywords: ''
...
Microsoft Intune usa las [entidades Graph API](https://docs.microsoft.com/graph/api/resources/intune-graph-overview) (abre otro sitio de Microsoft Docs) para configurar dispositivos (**Intune** > **Configuración del dispositivo**) que ejecutan Windows 10 y versiones posteriores. Graph API usa proveedores de servicios de configuración (CSP) para leer, establecer, cambiar o eliminar valores de configuración en dispositivos.

Esta lista se aplica a:

- Windows 10 y versiones posteriores

En este artículo se indican las entidades Graph y sus CSP de Windows 10 y URI de desplazamiento coincidentes.

Esta información resulta útil para diversos escenarios. Por ejemplo, vea qué se usa en Intune, vea los valores que se deben incluir en configuraciones OMA-URI personalizadas, etc. 

## <a name="windows-10-csps"></a>CSP de Windows 10

Para obtener más información sobre los proveedores de servicios de configuración de Windows 10, vea [Referencia de proveedor de servicios de configuración](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (abre otro sitio de Microsoft Docs).

## <a name="graph-api-properties-to-csp-mapping"></a>Propiedades de Graph API para la asignación de CSP

En la lista siguiente se muestran la mayoría de entidades Graph API usadas por Microsoft Intune para la configuración de dispositivos con Windows 10. También se muestran el CSP de Windows 10 y el URI de desplazamiento correspondientes.

Para ver las versiones de Windows 10 a las que se aplican las siguientes API, consulte [Referencia de proveedor de servicios de configuración](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (abre otro sitio de Microsoft Docs).
...
### <a name="sharedpcconfigurationaccountmanagerpolicy-windows-holographic-for-business-edition-targeted-devices"></a>SharedPCConfiguration.AccountManagerPolicy (dispositivos para Windows Holographic for Business) 
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI de desplazamiento**: /Config/Defender/ControlledFolderAccessProtectedFolders
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI de desplazamiento**: /Config/ExploitGuard/ExploitProtectionSettings
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI de desplazamiento**: /Config/Defender/ControlledFolderAccessAllowedApplications
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI de desplazamiento**: /Config/Defender/EnableNetworkProtection
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI de desplazamiento**: /Config/WindowsDefenderSecurityCenter/DisallowExploitProtectionOverride
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI de desplazamiento**: /Config/DeviceGuard/EnableVirtualizationBasedSecurity
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de desplazamiento**: /Config/RemoteManagement/AllowBasicAuthentication\_Client
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de desplazamiento**: /Config/RemoteManagement/AllowUnencryptedTraffic\_Client
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de desplazamiento**: /Config/RemoteManagement/AllowBasicAuthentication\_Service
...
**CSP**: ./Device/Vendor/MSFT/Policy  
**URI de desplazamiento**: /Config/RemoteManagement/AllowUnencryptedTraffic\_Service
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI de desplazamiento**: /Config/DeviceGuard/RequirePlatformSecurityFeatures
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI de desplazamiento**: /Config/SmartScreen/EnableSmartScreenInShell
...
**CSP**: N/A; Graph API de solo llamada **URI de desplazamiento**: N/A; Graph API de solo llamada
...
**URI de desplazamiento**: /Configuration
...
**CSP**: ./Device/Vendor/MSFT/Policy **URI de desplazamiento**: /Config/Update/ActiveHoursStart, /Config/Update/ActiveHoursEnd, /Config/Update/ScheduledInstallDay, /Config/Update/ScheduledInstallTime
...
- [Referencia de proveedor de servicios de configuración](https://docs.microsoft.com/windows/client-management/mdm/configuration-service-provider-reference) (abre otro sitio de Microsoft Docs)
