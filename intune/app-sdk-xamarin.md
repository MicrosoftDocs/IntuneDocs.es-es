...
* Registre el identificador de su aplicación. Lo encontrará en [Azure Portal](https://portal.azure.com/), en **Todas las aplicaciones**, en la columna de **Id. de aplicación**. En Azure Portal:
