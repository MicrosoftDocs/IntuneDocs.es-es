...
1. En el __Dock__, busque __Safari__ y abra la página [Centro de descarga de Microsoft](https://www.microsoft.com/download/details.aspx?id=55770) para encontrar la aplicación Portal de empresa para macOS.
